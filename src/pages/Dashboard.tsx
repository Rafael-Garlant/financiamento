            ...
            <div className="mx-auto max-w-4xl space-y-8">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button
                            onClick={signOut}
                            className="rounded-lg bg-white dark:bg-[#1d181f] border border-slate-200 dark:border-[#2f2532] text-slate-500 dark:text-slate-400 px-4 py-2 text-xs font-bold hover:bg-slate-50 dark:hover:bg-[#251e27] transition-all"
                        >
                            Sair
                        </button>
                    </div>
